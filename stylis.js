      ...
      switch (code) {
        ...
        default: {
          ...
          switch (code) {
            ...
            case AT: {
              if (
                comment + parentheses + quote + bracket + pseudo + atrule ===
                0
              ) {
                atrule = 1
              }
  ...
  function property(input, first, second, third) {
    ...
    switch (hash) {
      ...
      case 932: {
        if (out.charCodeAt(4) === DASH) {
          switch (out.charCodeAt(5)) {
            ...
            case 98: {
              return (
                webkit + out + ms + out.replace('basis', 'preferred-size') + out
              )
            }
          }
        }
      ...
      case 975: {
        ...
        cache = (out.charCodeAt(index) === 33 ? out.substring(0, index) : out)
      ...
      case 953: {
        if (dimensionptn.test(input) === true) {
          // stretch
          if (
            (cache = input.substring(input.indexOf(':') + 1)).charCodeAt(0) ===
            115
          )
            return property(
        ...
        switch (code) {
          ...
          default: {
            if (size > 1 && element.indexOf(':') > 0) {
              element =
                padding + element.replace(pseudoptn, '$1' + nscopealt + '$2')
            } else {
              element = padding + element + nscopealt
            }
          }
